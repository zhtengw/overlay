...
if [[ ${PV} == 9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/ChisBread/transmission"
else
	MY_PV="${PV}-${PR}"
	MY_P="${PN}-${MY_PV}"
	MY_PN="transmission_pt_edition"
	SRC_URI="https://github.com/ChisBread/transmission_pt_edition/archive/refs/tags/${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
...
HOMEPAGE="https://transmissionbt.com/
		https://github.com/ChisBread/transmission"
...
src_install() {
	...
	mv ${D}/usr/share/transmission/web/index.html ${D}/usr/share/transmission/web/index.original.html
	insinto /usr/share/transmission/web
	doins -r "${FILESDIR}"/transmission-web-control/src/*
}
