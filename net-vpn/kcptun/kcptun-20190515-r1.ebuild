...
EGO_VENDOR=(
	...
	"golang.org/x/net                 aaf6012 github.com/golang/net" # 20180816
	"golang.org/x/crypto              22d7a77 github.com/golang/crypto" # 20190514
)
...
src_install() {
	...
	for x in client $(usev server); do
		...
		systemd_dounit "${FILESDIR}"/kcptun-${x}.service
